...
```
Raw Data → QC & Filtering → Normalisation → Integration → Clustering → Annotation → DE Analysis
```

| Session | Duration | Topics |
|---------|----------|--------|
| **Session 1** | 3 hours | QC, Normalisation, Integration, Clustering, Annotation, DE |
| **Session 2** | 3 hours | *[Afternoon topics]* |
...
| [**Module 1**](articles/01_quality_control.html) | Quality Control | 45 min | QC metrics, doublet detection, cell filtering |
...
| Module | Topic | Duration | Description |
|--------|-------|----------|-------------|
| **Module 5** | *[Topic]* | XX min | *[Description]* |
| **Module 6** | *[Topic]* | XX min | *[Description]* |
| **Module 7** | *[Topic]* | XX min | *[Description]* |
