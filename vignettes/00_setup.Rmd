...
For afternoon session, download `afternoonSession.zip` from this [Zenodo repository](https://zenodo.org/records/20017845). Unzip it and add files to data and results folders as instructed there.
